...
### 1. Prerequisites
Ensure you have Python **3.13** or higher installed. It is recommended to use `uv` or `pip` to manage dependencies.
...
1. Input your document request in the prompt area.
2. Monitor real-time status updates and execution log traces.
3. Download the generated `.docx` file once completion is reached.
